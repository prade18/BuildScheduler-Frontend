...
//         localStorage.removeItem('justRegistered') // ✅ Clear the flag
...
//       if (res.ok) {
//         const { token, username, role } = data.data;
...
//         // ✅ Dispatch to Redux
//         dispatch(loginSuccess({ token, email, username, role }));

//         // ✅ Optional: clear flags and redirect
